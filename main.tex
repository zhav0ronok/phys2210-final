...
\begin{multicols*}{3} % Start of 3-column layout
    ...
    Our goal was to analyze the conditions under which they occur (namely, how the thickness, tension and and playing position of the string affect the resultant sound).
